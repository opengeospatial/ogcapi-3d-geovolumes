...
[width=100%]
|===
| image::011.jpg["Bounding box",208,208]  | Bounding Box YAML:
...
box:
  ...
  maxItems: 12
----
| image::012.jpg["Bounding Region",208,208]  | Bounding Region YAML:
[source%unnumbered,yaml]
----
box:
  type: array
  ...
  maxItems: 6
----
| image::013.jpg["Bounding Sphere",208,208]  | Bounding Sphere YAML:
[source%unnumbered,yaml]
----
box:
  type: array
